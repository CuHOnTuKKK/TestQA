...
чтобы убедится что наличие товаров коректно отображается на складе

Сценарий: Загрузка документов 
* Загрузка данных
...
* Формирование отчета
	...
	И я жду, что в табличном документе 'Результат' ячейка 'R7C6' станет равна '515,00' в течение 20 секунд
